    ...
    <div className='bodyofloginform'>
      ...
      <form action="POST" onSubmit={handleSubmit} className='formoflogin'>
        ...
        <div className="divoflogin">
          <input type="text" placeholder='Name' name='name' className='inputsoflogin' autoComplete='off' required />
        </div>
        <div className="divoflogin">
          <input type="email" name='email' placeholder='Email' className='inputsoflogin' autoComplete='off' required />
        </div>
        <div className="divoflogin">
          <input type="number" name='phone' placeholder='Phone' className='inputsoflogin' autoComplete='off' required />
        </div>
        <div className="divoflogin">
          <input type="password" name='password' placeholder='Password' className='inputsoflogin' autoComplete='off' required />
        </div>
